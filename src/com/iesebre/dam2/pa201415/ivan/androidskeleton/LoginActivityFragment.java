...
public class LoginActivityFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSignIn = (Button) view.findViewById(R.id.btnGplus);
        loginButton = (LoginButton) view.findViewById(R.id.btnFb);
        //Set click listeners
        btnTwitter.setOnClickListener((OnClickListener) getActivity());
        btnSignIn.setOnClickListener((OnClickListener) getActivity());
        //For Facebook
